...
function Login() {
  const { swLogo, formData, setFormData, setIsLoggedIn } = useContext(Context);
...
=======
          navigate("/starships");
>>>>>>> a16588ec8083ceb07d6391cc647858a34f6cdb83
  }
            ...
            <div className="flex-row items-center justify-between p-4 md:p-5">
              ...
              <p>
                <small>
                  ...
                  You'll be able to log into services and experiences using the
            ...
            <div className="p-4 md:p-5">
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    type="text"
                    className="bg-gray-200 border text-black text-sm block w-full p-4 mt-5"
